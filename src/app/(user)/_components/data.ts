...
export const SHOPS: Shop[] = [
  {
    ...
    categories: ["All", "Fruits & Veg", "Dairy", "Snacks"],
    products: [
      { id: "p1", name: "Bananas", unit: "1 kg", price: 49, img: "https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=300", category: "Fruits & Veg" }
    ]
  },
  {
    id: "shop-2",
    name: "Kairali Organics",
    ...
    categories: ["Organic", "Rice", "Spices"],
    products: [
      { id: "p2", name: "Organic Rice", unit: "1 kg", price: 120, img: "https://images.unsplash.com/photo-1586201375761-83865001e31c?w=300", category: "Rice" }
    ]
  },
  {
    id: "shop-3",
    ...
    products: [
      { id: "p3", name: "Fresh Milk", unit: "1 L", price: 58, img: "https://images.unsplash.com/photo-1550583724-b2692b85b150?w=300", category: "Milk" }
    ]
  },
  {
    id: "shop-4",
    name: "Spice Village",
    img: "https://images.unsplash.com/photo-1506617420156-8e4536971650?w=400",
    type: "organic",
    rating: 4.9,
    // time: "25–35",
    deliveryFee: 25,
    // address: "Munnar, Idukki",
    categories: ["Spices", "Tea", "Coffee"],
    products: [
      { id: "p4", name: "Cardamom", unit: "250 g", price: 320, img: "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=300", category: "Spices" }
    ]
  },
  {
    id: "shop-5",
    ...
    deliveryFee: 12,
    // address: "Fort Kochi",
    categories: ["Bread", "Cake", "Snacks"],
    products: [
      { id: "p5", name: "Plum Cake", unit: "500 g", price: 280, img: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=300", category: "Cake" }
    ]
  },
  {
    id: "shop-6",
    name: "Kerala Fish Hub",
    ...
    products: [
      { id: "p6", name: "Karimeen", unit: "1 kg", price: 420, img: "https://images.unsplash.com/photo-1544943910-4c1dc44aab44?w=300", category: "Fish" }
    ]
  },
  {
    id: "shop-7",
    name: "Travancore Super Store",
    img: "https://images.unsplash.com/photo-1516594798947-e65505dbb29d?w=400",
    type: "supermarket",
    rating: 4.3,
    // time: "18–24",
    deliveryFee: 22,
    ...
    products: [
      { id: "p7", name: "Sunflower Oil", unit: "1 L", price: 160, img: "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=300", category: "Groceries" }
    ]
  },
  {
    id: "shop-8",
    ...
    products: [
      { id: "p8", name: "Organic Tomato", unit: "1 kg", price: 70, img: "https://images.unsplash.com/photo-1546094096-0df4bcaaa337?w=300", category: "Vegetables" }
    ]
  },
  {
    id: "shop-9",
    ...
    products: [
      { id: "p9", name: "Chicken Curry Cut", unit: "1 kg", price: 240, img: "https://images.unsplash.com/photo-1604503468506-a8da13d82791?w=300", category: "Chicken" }
    ]
  },
  {
    id: "shop-10",
    name: "Backwater Bakers",
    img: "https://images.unsplash.com/photo-1517433670267-08bbd4be890f?w=400",
    type: "bakery",
    rating: 4.8,
    // time: "12–18",
    deliveryFee: 14,
    ...
    products: [
      { id: "p10", name: "Butter Cookies", unit: "250 g", price: 110, img: "https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=300", category: "Cookies" }
    ]
  },
  {
    id: "shop-11",
    name: "Nilgiri Fresh",
    img: "https://images.unsplash.com/photo-1543168256-418811576931?w=400",
    type: "supermarket",
    rating: 4.6,
    // time: "16–22",
    deliveryFee: 19,
    ...
    products: [
      { id: "p11", name: "Apples", unit: "1 kg", price: 180, img: "https://images.unsplash.com/photo-1567306226416-28f0efdc88ce?w=300", category: "Fruits" }
    ]
  },
  {
    id: "shop-12",
    name: "Kerala Farm House",
    ...
    deliveryFee: 20,
    // address: "Wayanad",
    categories: ["Farm Fresh", "Honey"],
    products: [
      { id: "p12", name: "Wild Honey", unit: "500 ml", price: 260, img: "https://images.unsplash.com/photo-1587049352851-8d4e89133924?w=300", category: "Honey" }
    ]
  }
];
